        ...
        <div class="title-bar header-title">
          ...
          <div class="icon-links displayflex">
            ...
            <ul class="liststylenone listsocialicon">
              ${A(this.socialprofiles,i=>p`<li class="icon-link-item"><a href="${i.url}" class="icon-link" ><img src=${i.image} alt="${i.network} logo" width="${this.width}" height="${this.width}" /></a></li>`)}
            </ul>
            <ul class=liststylenone>

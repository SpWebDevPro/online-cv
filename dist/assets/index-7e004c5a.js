...
`),t.achievementline=e;return p`
    ...
    `];Je([S()],G.prototype,"title",2);G=Je([P("my-skills")],G);class bt{constructor(e,t){this.name=e,this.image=t}}const yt="/online-cv/assets/Angular.png",$t="/online-cv/assets/CSS.png",wt="/online-cv/assets/Git.png",_t="/online-cv/assets/GoogleAppScript.png",At="/online-cv/assets/HTML.png",St="/online-cv/assets/Javascript.png",Pt="/online-cv/assets/LitJs.png",xt="/online-cv/assets/NodeJS.png",Et="/online-cv/assets/PWA.png",kt="/online-cv/assets/Rxjs.png",Ct="/online-cv/assets/Typescript.png",Tt="/online-cv/assets/ViteJs.png",Dt="/online-cv/assets/VueJs.png",Ot="/online-cv/assets/Wordpress.png";var Mt=Object.defineProperty,jt=Object.getOwnPropertyDescriptor,We=(s,e,t,i)=>{for(var n=i>1?void 0:i?jt(e,t):e,r=s.length-1,o;r>=0;r--)(o=s[r])&&(n=(i?o(e,t,n):o(n))||n);return i&&n&&Mt(e,t,n),n};let K=class extends y{constructor(){super(...arguments),this.technos=g[0].sections.skills.items[1].keywords,this.technosPath=[yt,$t,wt,_t,At,St,Pt,xt,Et,kt,Ct,Tt,Dt,Ot],this.technoMap=[],this.withLogo="35"}render(){for(let s of this.technos)for(let e of this.technosPath)if(this.checkTechnoName(e)===s){let t=new bt(s,e);this.technoMap.push(t)}return p`
